...
<html>
	...
	<body>
			...
			<div class="about3">
			<h1 align=center><u>Manage Books</u></h1>
			</div>
...
?>			
				...
				<div class="card">
					<img src="<?php echo $row["imagepath"]; ?>" style="width:251px ; height:350px ; border-radius: 24px;">

					<p><h1><?php echo $row["name"]; ?></h1></p>

					<p class="price"><?php echo $row["price"]; ?></p>

					<p><a href=editBook.php?id=<?php echo $row["id"]; ?>>Edit Listing</a>&nbsp;
					<a href=deleteBook.php?id=<?php echo $row["id"]; ?>>Delete Book</a></p>                    					
				</div>
